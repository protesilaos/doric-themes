;;; doric-valley-theme.el --- Minimalist theme with dark background and teal+gold hues -*- lexical-binding:t -*-
...
(eval-and-compile
  ...
  (doric-themes-define-theme doric-valley dark "Minimalist theme with dark background and teal+gold hues"))
